...
func (t *Mimir) initQuerier() (serv services.Service, err error) {
	...
	if !t.Cfg.isAnyModuleEnabled(QueryFrontend, QueryScheduler, Read, All) {
		...
		internalQuerierRouter = nethttp.MiddlewareFunc(otel.Tracer("github.com/grafana/mimir"), internalQuerierRouter.ServeHTTP, nethttp.OperationNameFunc(func(r *http.Request) string {
